...
import { PRIORITY_LABELS, type CockpitCategoryKey, type CockpitUnresolvedItem } from "./model";
...
export function CockpitUnresolvedItems({
  ...
  /** 行のアクション。対象カテゴリを選択し、既存の回答 UI へ移動する。 */
  onSelect: (item: CockpitUnresolvedItem, category: CockpitCategoryKey | null) => void;
}) {
  return (
