...
Gapを起点に目的・UX・機能と確認範囲を照合し、仮説を共同調査へ渡し、結果から要件を修正して
元の判断へ戻れること。具体的な導線は[共同検討UX](../01-specifications/ux/decision-discussion-workflow.md)
が所有する。取得できなかった情報を、機能や証拠の不存在と混同しない。
